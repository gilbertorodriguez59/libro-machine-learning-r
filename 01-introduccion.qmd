...
La formulación matemática del aprendizaje supervisado y la teoría de clasificación se desarrolla con mayor profundidad en los capítulos 5 y 6 de *Fundamentos Matemáticos del Aprendizaje Automático* [@rodriguez2026fundamentos].
:::
...
En la programación tradicional, una persona define reglas explícitas. En aprendizaje automático, se proporcionan ejemplos para que un algoritmo aprenda una relación entre variables de entrada y una salida esperada.
...
::: {.callout-tip title="Interpretación del resultado"}
...
::: {.callout-note title="Explicación del código"}
Se divide la base en dos partes: una para entrenar el modelo y otra para evaluar cómo funciona con datos no utilizados durante el ajuste.
:::
...
::: {.callout-tip title="Interpretación del resultado"}
La matriz de confusión compara la clase real con la clase predicha. La exactitud mide la proporción de aciertos.
:::
...
| Cuaderno Google Colab | Cuaderno autónomo para ejecutar los ejemplos del capítulo. | [Abrir en Google Colab](https://colab.research.google.com/github/gilbertorodriguez59/libro-machine-learning-r/blob/main/colab/01-introduccion.ipynb){target="_blank"} | — |
...
::: {.content-visible when-format="html"}
Este laboratorio muestra cómo una regla sencilla puede clasificar observaciones a partir de un umbral.
