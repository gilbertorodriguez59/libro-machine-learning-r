...
n_muestra_atus_svm <- min(6000L, nrow(atus_svm))
atus_svm <- atus_svm |>
  slice_sample(n = n_muestra_atus_svm)
...
set.seed(2026)
n_muestra_covid_svm <- min(6000L, nrow(covid_svm))
covid_svm <- covid_svm |>
  slice_sample(n = n_muestra_covid_svm)
